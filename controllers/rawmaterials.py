...
inventory_collection = DBConfig("rawmaterials")  # Call tinhe DBConfig function


# Route to add items to MongoDB
def add_items_route(inventory_collection):
    try:
...
def get_items_route(inventory_collection):
    try:
