...
def add_items_route():
    try:
        ...
        item_prepdate = data.get("prepdate")
        item_doneby = data.get("donyby")
...
def get_items_route():
    try:
        ...
        formatted_items = [{"name": item["name"],"expiry_date":item["expirydate"],"quantity":item["quantity"],"prepared_date":item["prepdate"],"done_by":item["doneby"]} for item in items]
